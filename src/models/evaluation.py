...
# initialize dagshub
import dagshub
dagshub.init(repo_owner='Aman-7745', 
             repo_name='swiggy-delivery-time-prediction', 
             mlflow=True)

# set the mlflow tracking server
mlflow.set_tracking_uri("https://dagshub.com/Aman-7745/deleivery_time_prediction.mlflow")
...
if __name__ == "__main__":
    ...
    with mlflow.start_run() as run:
        ...
        mlflow.sklearn.save_model(model, "model_dir", signature=model_signature)
